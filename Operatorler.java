...
public class Operatorler {
  ...
  public static void main(String[] args) {
    ...
    // sayac++ şeklindeki kullanımda ise sayacın değeri döndürülür ve sayaç 1 arttırılır.
    ...
    /*
     * Ek olarak, bir sayı diğerinden büyük veya eşitse >= küçük veya eşitse <= operatörleri kullanılır.
     * İki sayının birbirine eşit olmadığı karşılaştırılmak isteniyorsa != kullanılır.
